...
public class DiagnoseMedicament {
	...
	public DiagnoseMedicament(Long diagnoseId, Long medicamentId, String medicamentName, String medicamentCategory) {
		super();
	...
	public String toString() {
		return "DiagnoseMedicament [id=" + id + ", diagnoseId=" + diagnoseId + ", medicamentId=" + medicamentId
				+ ", medicamentName=" + medicamentName + ", medicamentCategory=" + medicamentCategory + ", patientId="
				+ patientId + ", date=" + date + ", doctorId=" + doctorId + ", illnessName=" + illnessName + "]";
	}
